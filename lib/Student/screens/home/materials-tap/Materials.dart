                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: DropdownButtonFormField(
                              hint: Text(
                                  "${CacheHelper().getData(key: ApiKey.selectedLevel) ?? CacheHelper().getData(key: ApiKey.userLevelSaved)}"),
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: DropdownButtonFormField(
                              hint: Text(
                                  "${CacheHelper().getData(key: ApiKey.selectedTerm) ?? CacheHelper().getData(key: ApiKey.userTermSaved)}"),
                              decoration: InputDecoration(
                                enabledBorder: OutlineInputBorder(
                                  borderSide:
                                  BorderSide(color: Colors.white, width: 1),
